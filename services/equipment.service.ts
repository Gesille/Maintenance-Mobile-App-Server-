...
async function buildQRGrid(doc: InstanceType<typeof PDFDocument>, items: any[]) {
...
export async function buildAllQRPdf(): Promise<InstanceType<typeof PDFDocument>> {
...
export async function buildSingleQRPdf(
  id: number,
...
export async function createEquipmentService(input: CreateEquipmentInput) {
