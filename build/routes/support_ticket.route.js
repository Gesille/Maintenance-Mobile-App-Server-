...
// ─── User routes ──────────────────────────────────────────────────────────────
supportTicketRouter.post("/create-ticket", isAuthenticated, createTicket);
supportTicketRouter.get("/my-tickets", isAuthenticated, getMyTickets);
supportTicketRouter.get("/my-tickets/:id", isAuthenticated, getTicketById);
